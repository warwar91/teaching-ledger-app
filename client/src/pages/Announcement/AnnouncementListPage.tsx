...
import { Megaphone, ChevronLeft, ChevronRight, CalendarDays, User } from 'lucide-react';
            ...
            {list.map((item) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <h3 className="text-sm sm:text-base font-medium text-gray-900 leading-snug flex-1">
                    {item.title}
                  </h3>
